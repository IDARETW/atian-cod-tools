...
Use `mw19pools --test` for bounded capability checks that write only reports. See the [MW2019 documentation](docs/mw19/README.md), [complete pool map](docs/mw19/pools.md), and [IW8 linker instructions](docs/mw19/linker.md). The original download links above point to upstream builds and do not include this fork's additions.
